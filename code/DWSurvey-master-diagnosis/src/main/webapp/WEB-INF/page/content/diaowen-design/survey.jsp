...
<title>问卷编辑</title>
<link
	href="${ctx }/js/plugs/jquery-ui-1.10.3.custom/css/mycss/jquery-ui-1.10.3.custom.css"
...
<script type="text/javascript" charset="utf-8"
	src="${ctx }/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.all.min.js">
...
<link href="${ctx }/css/design-survey.css" rel="stylesheet"
	type="text/css" />
...
<body>
	<div id="wrap">
		...
		<input type="hidden" id="ctx" value="${ctx }"> <input
			type="hidden" id="surveyModel_hidden" value="${survey.surveyModel }">

		<%--<div id="header">--%>
			<%--<div id="header_left">--%>
				<%--&lt;%&ndash; <img alt="调问网" src="${ctx }/images/logo/logo.jpg" > &ndash;%&gt;--%>
				<%--<!-- <div id="header_title">DIAOWEN-在线问卷编辑器</div> -->--%>
				<%--<div class="header_Item header_logo">--%>
					<%--<a href="${ctx }/"><img alt="调问网"--%>
						<%--src="${ctx }/images/logo/LOGO.png"></a>--%>
					<%--<!-- <div style="font-family: '微软雅黑';font-size:26px;padding-left:10px;">DIAOWEN&nbsp;&nbsp; </div>-->--%>
					<%--&nbsp;&nbsp; <span--%>
						<%--style="font-family: '微软雅黑'; font-size: 16px; line-height: 46px;"--%>
						<%--id="pageHeaderSpan">在线问卷编辑器</span>--%>
				<%--</div>--%>
			<%--</div>--%>
			<%--<div id="header_right">--%>
										...
										<div class="dwQuTypeModel">
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													<input type="hidden" name="quType" value="RADIO"> <input
														type="hidden" name="quId" value=""> <input
														type="hidden" name="orderById" value="0" /> <input
														type="hidden" name="saveTag" value="0"> <input
														type="hidden" name="hoverTag" value="0"> <input
														type="hidden" name="isRequired" value="1"> <input
														type="hidden" name="hv" value="2"> <input
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="contactsAttr" value="0"> <input
														type="hidden" name="contactsField" value="0">
												...
												<div class="surveyQuItem">
													<div class="surveyQuItemLeftTools">
														<ul class="surveyQuItemLeftToolsUl">
															<li title="移动排序" class="dwQuMove"><div
																	class="dwQuIcon"></div></li>
															<li title="设置" class="dwQuSet"><div class=dwQuIcon></div></li>
															<li title="逻辑" class="dwQuLogic"><div
																	class="dwQuIcon">
																	<div class="quLogicInfo"></div>
																</div></li>
															<li title="删除" class="dwQuDelete"><div
																	class="dwQuIcon"></div></li>
														</ul>
													</div>
													...
													<div class="surveyQuItemContent">
														...
														<div class="quCoItem">
															<ul>
																<li class="quCoItemUlLi"><input type="radio"><label
														...
														<div class="quCoBottomTools">
															<ul class="quCoBottomToolsUl">
																<li class="addOption" title="添加"><div
																		class="dwQuIcon"></div></li>
																<li class="addMoreOption" title="批量添加"><div
																		class="dwQuIcon"></div></li>
															</ul>
														</div>
													</div>
										...
										<div class="dwQuTypeModel">
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														type="hidden" name="orderById" value="0" /> <input
														type="hidden" name="saveTag" value="0"> <input
														type="hidden" name="hoverTag" value="0"> <input
														type="hidden" name="isRequired" value="1"> <input
												...
												<div class="surveyQuItem">
													...
													<div class="surveyQuItemContent">
														...
														<div class="quCoItem">
															<ul>
																<li class="quCoItemUlLi"><input type="checkbox"><label
																	class="editAble quCoOptionEdit">选项1</label>
																	<div class="quItemInputCase">
																		<input type="hidden" name="quItemId" value="">
																		<input type="hidden" name="quItemSaveTag" value="0">
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="checkType" value="NO"> <input
														type="hidden" name="answerInputWidth" value="300">
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="paramInt01" value="1"> <input
														type="hidden" name="paramInt02" value="5">
													<div class="quLogicInputCase">
														<input type="hidden" name="quLogicItemNum" value="0">
													</div>
												</div>
															...
															<table class="quCoItemTable" cellpadding="0"
																...
																<tr class="quScoreOptionTr">
																	<td class="quCoItemTableTd quOptionEditTd"><label
																		class="editAble quCoOptionEdit">分项1</label>
																		<div class="quItemInputCase">
																			<input type="hidden" name="quItemId" value=""><input
																				type="hidden" name="quItemSaveTag" value="0">
																		</div></td>
																	<td class="quCoItemTableTd"><table
																			class="scoreNumTable">
																			<tr>
																				<td>1</td>
																				<td>2</td>
																...
																<tr class="quScoreOptionTr">
																	<td class="quCoItemTableTd quOptionEditTd"><label
																		class="editAble quCoOptionEdit">分项2</label>
																		<div class="quItemInputCase">
																			<input type="hidden" name="quItemId" value=""><input
																				type="hidden" name="quItemSaveTag" value="0">
																		</div></td>
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="hv" value="2"> <input
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0">
													<div class="quLogicInputCase">
														<input type="hidden" name="quLogicItemNum" value="0">
													</div>
												</div>
													...
													<div class="surveyQuItemContent">
														...
														<div class="quCoItem">
																...
																<table class="quCoChenTable">
																	<tr>
																		...
																		<td class="quChenColumnTd"><label
																			class="editAble quCoOptionEdit">列1</label>
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId" value=""><input
																					type="hidden" name="quItemSaveTag" value="0">
																			</div></td>
																		<td class="quChenColumnTd"><label
																			class="editAble quCoOptionEdit">列2</label>
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId" value=""><input
																					type="hidden" name="quItemSaveTag" value="0">
																			</div></td>
																	...
																	<tr class="quChenRowTr">
																		<td class="quChenRowTd"><label
																			class="editAble quCoOptionEdit">行1</label>
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId" value=""><input
																					type="hidden" name="quItemSaveTag" value="0">
																			</div></td>
																	...
																	<tr class="quChenRowTr">
																		<td class="quChenRowTd"><label
																			class="editAble quCoOptionEdit">行2</label>
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId" value=""><input
																					type="hidden" name="quItemSaveTag" value="0">
																			</div></td>
															...
															<div class="quCoRightTools">
																<ul class="quCoBottomToolsUl">
																	<li class="addColumnOption" title="添加"><div
																			class="dwQuIcon"></div></li>
																	<li class="addMoreColumnOption" title="批量添加"><div
																			class="dwQuIcon"></div></li>
																</ul>
															</div>
														</div>
														...
														<div class="quCoBottomTools">
															<ul class="quCoBottomToolsUl">
																<li class="addRowOption" title="添加"><div
																		class="dwQuIcon"></div></li>
																<li class="addMoreRowOption" title="批量添加"><div
																		class="dwQuIcon"></div></li>
															</ul>
														</div>
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="checkType" value="PHONENUM"> <input
														type="hidden" name="answerInputWidth" value="300">
													<input type="hidden" name="answerInputRow" value="1">
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="checkType" value="EMAIL"> <input
														type="hidden" name="answerInputWidth" value="300">
													<input type="hidden" name="answerInputRow" value="1">
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													<input type="hidden" name="quType" value="RADIO"> <input
														...
														type="hidden" name="hoverTag" value="0"> <input
														type="hidden" name="isRequired" value="1"> <input
														type="hidden" name="hv" value="1"> <input
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="contactsAttr" value="1"> <input
														type="hidden" name="contactsField" value="6">
									...
									<li id="cityQuModel" style="display: none;">
										...
										<div class="dwQuTypeModel">
											<div class="surveyQuItemBody quDragBody">
												...
												<input type="text" style="width:200px;padding:5px;">
												<div class="dwComEditMenuBtn" ></div>
											</div> --> <select style="padding: 5px;" class="hat_province"><option>--选择省--</option>
																</select> <select style="padding: 5px;" class="hat_city"><option>--选择市--</option>
																</select> <select style="padding: 5px;" class="hat_area"><option>--选择区--</option>
																</select>
																</li>
															</ul>
														</div>
											...
											<div class="surveyQuItemBody quDragBody">
												...
												<div class="quInputCase" style="display: none;">
													...
													<input type="hidden" name="quId" value=""> <input
														...
														type="hidden" name="randOrder" value="0"> <input
														type="hidden" name="cellCount" value="0"> <input
														type="hidden" name="checkType" value="DATE"> <input
														type="hidden" name="answerInputWidth" value="300">
													<input type="hidden" name="answerInputRow" value="1">
					...
					<div id="toolsPubBtn">
						<div class="toolbars" style="padding: 10px 15px 10px 0px;">
							<ul>
								...
								<li id="saveＭodelBtn" style="display: none;"
									class="saveＭodelBtn_li">
									<div class="dwToolbar_icon"></div>
								</li>
								<li id="saveBtn">
									<div class="dwToolbar_icon"></div>
		...
		<div id="dw_body">
			<div id="dw_body_left">
				...
				<div id="dwBodyLeftContent">
					<h2 class="">
						<a href="" class="ellipsis">欢迎页</a>
					</h2>
					<div>
						<div>
							<h2 class="">
								<a href="" class="ellipsis">问卷页</a>
							</h2>
						</div>

						<div style="padding-left: 5px;">
							<h2 class="">
								<a href="" class="ellipsis">1、请问你的年级是？</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">2、请问你的年级是？</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">3、请问你的年级是？</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">4、请问你的年级是？</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">下一页</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">5、请问你的年级是？</a>
							</h2>
							<h2 class="">
								<a href="" class="ellipsis">6、请问你的年级是级是级是？</a>
							</h2>
						</div>
					</div>
					<h2 class="">
						<a href="" class="ellipsis">结束页</a>
					</h2>
				</div>
			</div>
				...
				<div id="dwSurveyQuContent" style="min-height: 500px;">
					<ul id="dwSurveyQuContentAppUl">
						...
						<c:forEach items="${survey.questions }" var="en" varStatus="i">
							<li class="li_surveyQuItemBody"><c:choose>
									<c:when test="${en.quType eq 'RADIO' }">
										<div class="surveyQuItemBody">
											<div class="initLine"></div>
											<div class="quInputCase" style="display: none;">
												<input type="hidden" name="quType" value="RADIO"> <input
													type="hidden" name="quId" value="${en.id }"> <input
													type="hidden" name="orderById" value="${en.orderById }" />
												<input type="hidden" name="saveTag" value="1"> <input
													type="hidden" name="hoverTag" value="0"> <input
													type="hidden" name="isRequired" value="${en.isRequired }">
												<input type="hidden" name="hv" value="${en.hv }"> <input
													type="hidden" name="randOrder" value="${en.randOrder }">
												<input type="hidden" name="cellCount"
													value="${en.cellCount }"> <input type="hidden"
													name="contactsAttr" value="${en.contactsAttr }"> <input
													type="hidden" name="contactsField"
													value="${en.contactsField }">
												...
												<div class="quLogicInputCase">
													...
													<c:forEach items="${en.questionLogics }" var="quLogicEn"
														...
														<div class="quLogicItem quLogicItem_${logicSts.count }">
															<input type="hidden" name="quLogicId"
																value="${quLogicEn.id }" /> <input type="hidden"
																name="cgQuItemId" value="${quLogicEn.cgQuItemId }" /> <input
																type="hidden" name="skQuId" value="${quLogicEn.skQuId }" />
															<input type="hidden" name="visibility" value="1">
															<input type="hidden" name="logicSaveTag" value="1">

															<input type="hidden" name="geLe"
																value="${quLogicEn.geLe }"> <input type="hidden"
																name="scoreNum" value="${quLogicEn.scoreNum }">
																				...
																				<td width="${600/en.cellCount }">
																					<!-- 判断不为空，访止数组越界 --> <c:set var="quOptionIndex"
																						...
																						<c:when
																							...
																							<input type="radio">
																							<label style="width:${600/en.cellCount-10 }px;"
																							...
																							<div class="quItemInputCase">
																								<input type="hidden" name="quItemId"
																									...
																									type="hidden" name="quItemSaveTag" value="1">
																								<input type="hidden" name="isNote"
																									value="${item.isNote }"> <input
																									type="hidden" name="checkType"
																									value="${item.checkType }"> <input
																									type="hidden" name="isRequiredFill"
																		...
																		<li class="quCoItemUlLi"><input type="radio"><label
																			...
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId"
																					...
																					name="quItemSaveTag" value="1"> <input
																					type="hidden" name="isNote" value="${item.isNote }">
									...
									<c:when test="${en.quType eq 'CHECKBOX' }">
										<div class="surveyQuItemBody">
											...
											<div class="quInputCase" style="display: none;">
												...
												<input type="hidden" name="orderById"
													value="${en.orderById }" /> <input type="hidden"
													name="saveTag" value="1"> <input type="hidden"
													name="hoverTag" value="0"> <input type="hidden"
													name="isRequired" value="${en.isRequired }"> <input
													type="hidden" name="hv" value="${en.hv }"> <input
													type="hidden" name="randOrder" value="${en.randOrder }">
												<input type="hidden" name="cellCount"
													value="${en.cellCount }"> <input type="hidden"
													name="contactsAttr" value="${en.contactsAttr }"> <input
									...
									<c:when test="${en.quType eq 'FILLBLANK' }">
										<div class="surveyQuItemBody">
											...
											<div class="quInputCase" style="display: none;">
												...
												<input type="hidden" name="cellCount"
													value="${en.cellCount }"> <input type="hidden"
													name="checkType" value="${en.checkType }"> <input
													type="hidden" name="answerInputWidth"
													value="${en.answerInputWidth }"> <input
													type="hidden" name="answerInputRow"
													value="${en.answerInputRow }"> <input type="hidden"
													name="contactsAttr" value="${en.contactsAttr }"> <input
													type="hidden" name="contactsField"
													value="${en.contactsField }">
												<div class="quLogicInputCase">
									...
									<c:when test="${en.quType eq 'SCORE' }">
										<div class="surveyQuItemBody">
											<div class="initLine"></div>
											<div class="quInputCase" style="display: none;">
												<input type="hidden" name="quType" value="SCORE"> <input
													type="hidden" name="quId" value="${en.id }"> <input
													type="hidden" name="orderById" value="${en.orderById }" />
												<input type="hidden" name="saveTag" value="1"> <input
													type="hidden" name="hoverTag" value="0"> <input
												...
												<input type="hidden" name="cellCount"
													value="${en.cellCount }"> <input type="hidden"
													name="paramInt01" value="${en.paramInt01 }"> <input
													type="hidden" name="paramInt02" value="${en.paramInt02 }">
												<div class="quLogicInputCase">
													<input type="hidden" name="quLogicItemNum"
														value="${fn:length(en.questionLogics) }">
													<c:forEach items="${en.questionLogics }" var="quLogicEn"
															...
															<table class="quCoChenTable">
																<tr>
																	...
																	<c:forEach items="${en.columns }" var="columnItem">
																		<td class="quChenColumnTd"><label
																			class="editAble quCoOptionEdit">${columnItem.optionName }</label>
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId"
																					value="${columnItem.id }"><input
																					type="hidden" name="quItemSaveTag" value="1">
																			</div></td>
																	</c:forEach>
																</tr>
																<c:forEach items="${en.rows }" var="rowItem">
																	<tr class="quChenRowTr">
																		<td class="quChenRowTd"><label
																			...
																			<div class="quItemInputCase">
																				<input type="hidden" name="quItemId"
																					value="${rowItem.id }"><input type="hidden"
																					name="quItemSaveTag" value="1">
																			</div></td>
																		<c:forEach items="${en.columns }" var="columnItem">
																			<td><input type="radio"></td>
	...
	<div id="quRadioItem" class="modelHtml">
		...
		<div class="quItemInputCase">
			<input type="hidden" name="quItemId" value=""> <input
				type="hidden" name="quItemSaveTag" value="0"> <input
				type="hidden" name="isNote" value="0"> <input type="hidden"
				name="checkType" value="NO"> <input type="hidden"
				name="isRequiredFill" value="0">
		</div>
	</div>
	<!-- 多选选项模板 -->
	...
	<table class="modelHtml">
		<tr id="quScoreItemModel" class="quScoreOptionTr">
			<td class="quCoItemTableTd quOptionEditTd"><label
				class="editAble quCoOptionEdit">评分项</label>
				<div class="quItemInputCase">
					<input type="hidden" name="quItemId" value=""><input
						type="hidden" name="quItemSaveTag" value="0">
				</div></td>
	...
	<table class="modelHtml">
		<tr id="mFillblankTableModel">
			<td align="right" class="mFillblankTableEditTd"><label
				class="editAble quCoOptionEdit">大一</label>
				<div class="quItemInputCase">
					<input type="hidden" name="quItemId" value=""><input
						type="hidden" name="quItemSaveTag" value="0">
				</div></td>
	...
	<table class="modelHtml">
		<tr id="quChenColumnModel">
			<td class="quChenColumnTd"><label
				class="editAble quCoOptionEdit">新项</label>
				<div class="quItemInputCase">
					<input type="hidden" name="quItemId" value=""><input
						type="hidden" name="quItemSaveTag" value="0">
				</div></td>
		...
		<tr id="quChenRowModel">
			<td class="quChenRowTd"><label class="editAble quCoOptionEdit">新项</label>
				<div class="quItemInputCase">
					<input type="hidden" name="quItemId" value=""><input
						type="hidden" name="quItemSaveTag" value="0">
				</div></td>
	...
	<div id="quLogicItemModel" class="modelHtml">
		<div class="quLogicItem">
			<input type="hidden" name="quLogicId" value="" /> <input
				type="hidden" name="cgQuItemId" value="0" /> <input type="hidden"
				name="skQuId" value="0" /> <input type="hidden" name="visibility"
				value="0"> <input type="hidden" name="logicSaveTag"
				value="0"> <input type="hidden" name="geLe" value="le">
			<input type="hidden" name="scoreNum" value="2"> <input
				type="hidden" name="logicType" value="1">
		</div>
	</div>
	<table id="setQuLogicItem" style="display: none;">
		<tr id="setQuLogicItemTrModel">
			...
			<td>则&nbsp;<select name="option_id" class="logicType"
				style="width: 60px;"><option value="2">显示</option>
					<option value="1">跳到</option></select>
			</td>
		...
		<tr id="setQuLogicItemTrModel_score">
			...
			<td><select name="option_id" class="logicQuOptionSel"
				style="width: 120px;"></select> 评分&nbsp;<select
				name="logicScoreGtLt" class="logicScoreGtLt" style="width: 80px;"><option
						value="le">小等于</option>
					<option value="ge">大等于</option></select> <select name="logicScoreNum"
				class="logicScoreNum" style="width: 40px;"><option>2</option>
					<option>3</option></select>&nbsp;分,</td>
			<td>则&nbsp;<select name="logicEvent" class="logicType"
				style="width: 60px;"><option value="2">显示</option>
					<option value="1">跳到</option></select>
			</td>
			<td><select name="jump_to_qid" class="logicQuSel"></select></td>
	...
	<div id="dwCommonEditRoot">
		<div class="dwCommonEdit">
			<ul class="dwComEditMenuUl">
				<li><a href="javascript:;" class="SeniorEdit"><i
						class="menu_edit2_icon"></i>高级编辑</a></li>
				<li class="option_Set_Li"><a href="javascript:;"
					class="option_Set"><i class="menu_edit4_icon"></i>选项设置</a></li>
	...
	<div id="dialog" title="Basic dialog">
		...
		<div id="dialogUeBottom">
			<div class="dwQuDialogBtnCon">
				<input type="button" value="保存" class="quDialogBtn"
					id="dwDialogUeOk" />
			</div>
		</div>
	</div>
	...
	<div id="dwCommonDialog">
		...
		<div class="dwCommonDialogBody">
			<div class="dwCommonDialogTitle">
				<span id="dwComDialogTitleText">标题文本</span><span
					id="dwCommonDialogClose" class="closeDialog"></span>
			</div>
			<div class="dwCommonDialogContent">
				<!-- 默认显示的LOAD -->
				<div class="dwQuDialogLoad dwQuDialogCon">
				...
				<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon">
					<ul>
						...
						<li><label><input type="checkbox"
								name="setIsRequired">此题必答</label></li>
						<li class="optionAutoOrder"><label><input
								type="checkbox" name="setRandOrder">选择随机排列</label></li>
						<li class="contactsAttrLi"><label><input
								type="checkbox" name="setAutoContacts">关联到联系人属性</label></li>
						<li class="contactsFieldLi"><label>用户填写的内容，会成为联系人的</label> <select
							class="contacts_range" name="setContactsField"
							style="width: 120px;">
						...
						<li class="optionRangeHv"><label>选项排放：</label> <select
							class="option_range" name="setHv" style="width: 120px;">
								<option value="2">竖排</option>
								<option value="1">横排</option>
								<option value="3">按列</option>
								<!-- <option value="4">下拉显示</option> -->
						</select> <span class="option_range_3" style="display: none;"><input
								type="text" name="setCellCount" size="2" value="2">&nbsp;列</span>
						</li>
					...
					<li class="maxNumLi">最多选&nbsp;<input type="text" size="3" name="maxNum">&nbsp;项 </li> -->
						<li class="minMaxLi"><span class="minSpan"><label
								class="lgleftLabel">&nbsp;最低分</label>&nbsp;<input class="minNum"
								value="1" type="text" size="2">&nbsp; <label
								class="lgRightLabel">分</label></span>&nbsp;&nbsp; <span class="maxSpan"><label
								class="lgLeftLabel">最高分</label>&nbsp;<input class="maxNum"
								value="5" type="text" size="2">&nbsp;<label
								class="lgRightLabel">分</label> </span></li>
						<li class="scoreMinMax">&nbsp;&nbsp;<label>最高分</label>&nbsp;<select
							class="maxScore"><option value="5">5分</option>
								<option value="10">10分</option></select>&nbsp;
						</li>
					</ul>
					<div class="dwQuDialogBtnCon">
						<input type="button" value="保存" class="quDialogBtn"
							id="dwDialogQuSetSave" />
					</div>
				</div>
	...
	<div id="modelUIDialog">
		...
		<div id="modelUIDialogContent">
			...
			<div class="dwQuFillDataTypeOption dwQuFormSetDialog dwQuDialogCon">
				<ul>
					<li><label>输入框宽：</label> <input type="text"
						name="qu_inputWidth" value="300"><span>&nbsp;字符</span></li>
					<li><label>输入框高：</label> <input type="text" name="qu_inputRow"
						value="1"><span>&nbsp;行</span></li>
					<li><label>数据类型：</label> <select class="option_range"
						name="quFill_checkType" style="width: 120px;">
							...
							<!-- <option value="4">下拉显示</option> -->
					</select> <span class="option_range_3" style="display: none;">&nbsp;列</span>
					</li>
			...
			<div class="dwQuRadioCheckboxOption dwQuFormSetDialog dwQuDialogCon">
				<ul>
					...
					<li class="quOptionAddFill"><label><input
							type="checkbox" name="quOption_isNote">选项后添加填空</label></li>
					<li class="quOptionFillContentLi"><label
						style="padding-left: 16px;">填空内容：</label> <select
						class="option_range" name="quOption_checkType"
						style="width: 120px;">
					...
					<li class="quOptionFillRequiredLi"><label
						style="padding-left: 15px;"><input type="checkbox"
							name="quOption_isRequiredFill" checked="checked">&nbsp;该空可不填</label>&nbsp;</li>
					<!-- <li>最多选&nbsp;<input type="text" size="3">&nbsp;项 </li> -->
				</ul>
				<div class="dwQuDialogBtnCon">
					<input type="button" value="保存" class="quDialogBtn"
						id="dwDialogQuOptionSetSave" />
				</div>
			</div>
			...
			<div class="dwSurveyAttrSetDialog dwQuFormSetDialog dwQuDialogCon">
				<div class="tabbarDialog_1">
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="effective" value="4">
									每台电脑或手机只能答一次</label>
							</div>
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="effectiveIp"
									value="1"> 每个IP只能答一次</label>
							</div>
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="rule" value="3">
									启用访问密码</label> &nbsp;&nbsp;&nbsp;设置密码：<input type="text" size="10"
									name="ruleCode" class="inputSytle_1">
							</div>
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="refresh" value="1">
									有重复回答启用验证码</label>
							</div>
							<div class="p_DialogContentItem" style="display: none;">
								<label><input type="checkbox" name="mailOnly" value="1">
									只有邮件邀请唯一链接的受访者可回答</label>
							</div>
						</div>
					</div>
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="ynEndNum" value="1">
									收集到&nbsp;<input type="text" size="12" class="inputSytle_1"
									name="endNum">&nbsp;份答卷时结束</label>
							</div>
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="ynEndTime" value="1">
									到&nbsp;<input type="text" size="20" class="inputSytle_1 Wdate"
									onfocus="WdatePicker({minDate:'%y-%M-{%d+1}',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
									name="endTime">&nbsp;时结束 </label>
							</div>
						</div>
					</div>
					<div style="clear: both;"></div>
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="showShareSurvey"
									value="1"> 显示分享按钮，分享答题链接到更多社交网站</label>
							</div>
							<div class="p_DialogContentItem">
								<label><input type="checkbox" name="showAnswerDa"
									value="1"> 允许受访人答完问卷后查看结果</label>
							</div>
						</div>
					</div>
				</div>
...
<div id="dwCommonInputMenuRoot"  >
	...
	<!-- 初始化属性 -->
		...
		$(
				"input[name='effectiveIp'][value='${survey.surveyDetail.effectiveIp}']")
				.attr("checked", true);
		$("input[name='rule'][value='${survey.surveyDetail.rule}']").attr(
				"checked", true);
		$("input[name='ruleCode']").val("${survey.surveyDetail.ruleCode}");
		$("input[name='refresh'][value='${survey.surveyDetail.refresh}']")
				.attr("checked", true);
		$("input[name='mailOnly'][value='${survey.surveyDetail.mailOnly}']")
				.attr("checked", true);
		$("input[name='ynEndNum'][value='${survey.surveyDetail.ynEndNum}']")
				.attr("checked", true);
		$("input[name='endNum']").val("${survey.surveyDetail.endNum}");
		$("input[name='ynEndTime'][value='${survey.surveyDetail.ynEndTime}']")
				.attr("checked", true);
		$("input[name='endTime']").val("${survey.surveyDetail.endTime}");
		$(
				"input[name='showShareSurvey'][value='${survey.surveyDetail.showShareSurvey}']")
				.attr("checked", true);
		$(
				"input[name='showAnswerDa'][value='${survey.surveyDetail.showAnswerDa}']")
				.attr("checked", true);
	</script>
	...
	<div style="text-align: center;">
		<div class="dw_foot" style="padding-bottom: 30px;">
			<div class="footer-copyright"
				...
				Powered by <a href="/diaowen" target="_blank"
					style="text-decoration: none; color: gray;">南京科技职业学院</a>&nbsp;&nbsp;&nbsp;
				Copyright © 2012-2017 <a href="/diaowen" target="_blank"
					style="text-decoration: none; color: rgb(53, 117, 136);">南京科技职业学院</a>
			</div>
		</div>
	</div>
