...
.ui-btn ,ui-input-btn ,ui-btn-b ,ui-corner-all, ui-shadow{
    background-color: #5693C0 !important;
    border-color: #5693C0 !important;
    color: #fff !important;
...
<input type="hidden" id="e_desc" name="e_desc" value="${e_desc}">
<div data-role="page" >
  <div data-role="header">
    	<div id="dwSurveyTitle" class="noLogoImg" style="padding-top: 5px;">
			...
			<div style="font-size:12px;color:white;font-weight: normal">${e_desc}</div>
		</div>
		<div id="dwSurveyNote">
				...
				<li class="li_surveyQuItemBody surveyQu_${pageNo }"  style="${pageNo gt 1 ?'display: none':''}">
					<div class="surveyQuItemBody">
							<div class="surveyQuItem">
								...
								<div class="surveyQuItemContent" style="background-color: #3c9ef9;color: #FFFFFF;margin-bottom: 0px;min-height:20px;">
									<!-- <a href="#" data-theme="b"  data-role="button">提&nbsp;交</a>&nbsp;&nbsp; -->
									<input type="button" style="background-color: red" class="submitSurvey" id="submitSurvey" value="提&nbsp;交" data-role="button" data-theme="b" />
