	...
	<div id="dwBody" >
		...
		<div class="tab-content" style="background: #D9D9D9;padding: 0px 5px;">
				<div class="tab-content-collectTab icTab" style="text-align: left;">
					<a href="${ctx }/ic/user!myaccount" class="collectTab tabItem_1 active"><span class="collectTabItemLeft">&nbsp;</span><span>我的账号</span></a>
				</div>
		</div>
		<div id="dwBodyUser">
				...
				<div class="surveyCollectMiddleContent">
					<div style="padding: 25px 45px;overflow: auto;padding-top: 35px;">
							...
							<div style="padding: 5px;color:#666565; ">
								<form id="input_form" action="${ctx }/ic/user!save" method="post" >
								<table class="ac-form-table">
									...
									<tr>
										...
										<td class="ac-input-td"><a href="${ctx}/ic/user!pwd" >修改密码</a> </td>
									</tr>
									<tr>
										<td></td>
