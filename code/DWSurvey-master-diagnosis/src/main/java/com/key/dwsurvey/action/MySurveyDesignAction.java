...
//	@Result(name=MySurveyDesignAction.RELEASE,location="/WEB-INF/page/content/diaowen-design/release-success.jsp",type=Struts2Utils.DISPATCHER)
//})
...
//	protected final static String RELEASE="release";
//	
//	@Autowired
...
//			e.printStackTrace();
//		}
////		return COLLECTSURVEY; //转向问卷发布地址页面
//		return RELEASE; //转向成功提示页面
//	}
//	
